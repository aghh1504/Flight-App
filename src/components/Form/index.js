...
export default class Form extends Component {
  ...
  onSubmit = e => {
    e.preventDefault();
    const {from, to, when, time, arrivalsTime, airline, website, noBooking, price, isChecked} = this.state;
    const flights = {
      from: from,
      to: to,
      when: when,
          ...
          <button onClick={this.onModelOpen}>Add Flight</button>
          {
            ...
            <div className="form-wrapper">
              <form onSubmit={this.onSubmit}>
                 ...
                 <Row name='baggage' onChange={this.onChecked} checked={this.state.isChecked}/>
